...
<body>
    ...
    <!-- korzina_not start -->
    <div class="korzina_not container">
        <img src="assets/img/korzina_not/kor.svg" alt="">

        <div class="korzina_not_opis">
            <h3>В корзине пока ничего нет</h3>
            <p>Воспользуйтесь поиском, если ищете что-то конкретное или подберите в каталоге</p>
        </div>

        <button class="btn_pink">Перейти в каталог</button>
    </div>
    <!-- korzina_not end -->
